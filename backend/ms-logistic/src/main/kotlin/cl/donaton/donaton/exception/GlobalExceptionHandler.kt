...
class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TransportUnavailableException::class)
    fun handleTransportUnavailableException(ex: TransportUnavailableException): ResponseEntity<ErrorResponse> {
        return buildResponse(HttpStatus.CONFLICT, ex.message ?: "El transporte no está disponible")
    }
