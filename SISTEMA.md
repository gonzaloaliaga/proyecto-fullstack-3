...
- [`frontend-service`](./frontend-service/): aplicación React + Vite
- [`bff-service`](./bff-service/): gateway que valida JWT y reenvía peticiones
- [`auth-service`](./auth-service/): emite y valida JWT
- [`profile-service`](./profile-service/): gestiona perfiles de usuario
- [`donations-service`](./donations-service/): microservicio de donaciones (skeleton)
- [`inventory-service`](./inventory-service/): microservicio de inventario (skeleton)
- [`logistic-service`](./logistic-service/): microservicio de logística (skeleton)
- [Bases de datos PostgreSQL](./docker-compose.yml#101) para cada microservicio
...
Este documento detalla la implementación técnica. Para leer sobre el contexto del proyecto, reglas de negocio y requerimientos, visita el [README principal](README.md).